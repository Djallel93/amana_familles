 ...
 * @returns {Sheet} Bulk Import sheet
 */
function getOrCreateBulkImportSheet() {
    ...
    if (!sheet) {
        ...
        const headers = [
            'nom', 'prenom', 'nombre_adulte', 'nombre_enfant', 'adresse', 'code_postal', 'ville',
            'telephone', 'telephone_bis', 'email', 'se_deplace', 'circonstances', 'ressentit',
            'specificites', 'criticite', 'langue', 'commentaire'
        ];
        ...
        logInfo('Bulk Import sheet created successfully (Row 1: Headers, Row 2+: Data)');
    }
